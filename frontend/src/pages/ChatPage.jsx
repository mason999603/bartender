...
export default function ChatPage() {
    ...
    return (
        <>
            ...
            <div className="chat-shell max-w-4xl mx-auto flex flex-col">
                {/* Hero / empty state */}
                {messages.length === 0 && !loading && (
                    <div className="flex-1 overflow-y-auto flex flex-col items-center justify-center text-center fade-in px-4 sm:px-6 py-6">
                ...
                {messages.length > 0 && (
                    <>
                        ...
                        <div
                            ref={scrollRef}
                            className="flex-1 overflow-y-auto space-y-4 px-4 sm:px-6 pb-4"
                ...
                {/* Composer */}
                <div className="chat-composer glass px-3 py-2 relative" data-testid="chat-composer">
                    <div className="flex items-end gap-2">
                        <textarea
                            ...
                            rows={1}
                            className="flex-1 bg-transparent border-none outline-none px-3 py-2 text-base resize-none"
